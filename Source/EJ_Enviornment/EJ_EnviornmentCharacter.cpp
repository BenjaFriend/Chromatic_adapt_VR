	...
	if (ProjectileClass != NULL)
	{
		...
		if (World != NULL)
		{
			if (bUsingMotionControllers)
			{
				...
				World->SpawnActor<AEJ_EnviornmentProjectile>(ProjectileClass, SpawnLocation, SpawnRotation);
			}
			else
			{
				...
				World->SpawnActor<AEJ_EnviornmentProjectile>(ProjectileClass, SpawnLocation, SpawnRotation, ActorSpawnParams);
			}
		}
	}
...
//void AEJ_EnviornmentCharacter::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
//{
